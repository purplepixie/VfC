...
ALTER TABLE event ADD type ENUM('Demonstration','Fair or exhibition','Meeting or planning','Social or network','Talk or discussion','Training or workshop','Workday or volunteering','Other');
